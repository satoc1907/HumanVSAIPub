		...
		<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
         ...
         <!-- quizOptions -->
				<div class="optionContainer">
					<div class="option" v-for="(response, index) in quiz.questions[questionIndex].responses" @click="onActive(index); userResponses.splice(questionIndex,1,index) " :key="index" v-bind:class="{ 'is-selected': isActive === index }">
